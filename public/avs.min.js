...
function () {
  function AVS() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, AVS);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "_version", 0.01);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "room", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "sspc", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "vspc", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "aspc", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "config", {
      iceServers: [{
        urls: ['stun:27.5.7.57']
      }, {
        urls: ['turn:27.5.7.57'],
  ...
  */
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(AVS, [{
    key: "init",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 6;
                return socket.emit('join', this.room);
    ...
    key: "shareScreen",
    value: function () {
      var _shareScreen = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      ...
      function shareScreen() {
        return _shareScreen.apply(this, arguments);
      }
    ...
    value: function initListeners() {
      ...
      socket.on('offer', function (message) {
        ...
        console.log(_this.sspc.localDescription);
        console.log(message.description);
        console.log(_this.sspc.localDescription.sdp == message.description.sdp); // if(message.description.sdp != this.sspc.localDescription.sdp) {

        _this.sspc.setRemoteDescription(message.description).then(function () {
          return _this.sspc.createAnswer();
        }).then(function (sdp) {
          return _this.sspc.setLocalDescription(sdp);
        }).then(function () {
          socket.emit('answer', {
            room: _this.room,
            description: _this.sspc.localDescription
          });
        }); // }
      ...
      socket.on('answer', function (message) {
        ...
        _this.sspc.setRemoteDescription(message.description);
      });
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (AVS);
