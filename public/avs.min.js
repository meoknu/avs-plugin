...
var attachSocketEventHandlers = function attachSocketEventHandlers(socket, avs) {
  socket.on('peer_connected', function (peer_id) {
    console.log(peer_id);
  ...
  socket.on('connected_to_peer', function (peer_id) {
    var pc = new RTCPeerConnection(avs.config);
    pc.peer_id = peer_id;
    attachRPCEventHandlers(pc, avs);
    avs.peers.push(pc);
  });
  socket.on('disconnect_from_peer', function (peer_id) {
  ...
  socket.on('receive_offer', function (id, msg) {
  ...
  socket.on('receive_answer', function (id, msg) {
    var peer = avs.peers.find(function (p) {
      return p.peer_id == id;
    });
    peer.setRemoteDescription(msg);
  });
  socket.on('add_candidate', function (id, msg) {
    var peer = avs.peers.find(function (p) {
      return p.peer_id == id;
    });
...
function () {
  ...
  */
  ...
  function AVS(config) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, AVS);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "_version", 0.01);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "room", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "stream", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "streaming", false);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "socket", void 0);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "peers", []);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "videoElem", void 0);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(AVS, [{
    key: "broadcast",
    value: function broadcast() {
      ...
      navigator.mediaDevices.getDisplayMedia({
        ...
        var v = document.createElement('video'); // v.height = 100;

        v.controls = true;
        v.autoplay = true;
        v.srcObject = stream;
        document.body.appendChild(v); // pc.addStream(stream);
